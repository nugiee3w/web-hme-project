...
@section('title', 'Edit Kegiatan HME')
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            ...
                                            <small class="form-text text-muted">
                                                Format: JPG, JPEG, PNG, GIF. Maksimal 2MB. Kosongkan jika tidak ingin mengganti gambar.
                                            </small>
                                            @error('gambar')
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <select name="kategori" class="form-control select2 @error('kategori') is-invalid @enderror">
                                                ...
                                                <option value="Tahunan" {{ old('kategori', $kegiatan->kategori) == 'Tahunan' ? 'selected' : '' }}>Tahunan</option>
                                                <option value="Divisi" {{ old('kategori', $kegiatan->kategori) == 'Divisi' ? 'selected' : '' }}>Divisi</option>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-sm-12 col-md-7">
                                            <select name="status" class="form-control select2 @error('status') is-invalid @enderror">
                                                ...
                                                <option value="Published" {{ old('status', $kegiatan->status) == 'Published' ? 'selected' : '' }}>Published</option>
                                            </select>
                                            <small class="form-text text-muted">
